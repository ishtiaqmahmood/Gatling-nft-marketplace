...
// security against transaction for multiplr requests
...
contract Market is ReentrancyGuard {
	...
	// charge a listing fee so the owner makes a commissions
	...
	public payable nonReentrant {
		// nonReentrant is a modifier to prevent reenrey attack
		...
		function fetchMyNfts() public view returns (MarketToken[] memory) {
			...
			// a sesond counter for each individual user
			uint itemCount = 0;
			uint currentIndex = 0;
